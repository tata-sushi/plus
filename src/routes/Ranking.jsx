...
export function Ranking() {
  ...
  // Destaque da semana em produção: aba pra todos, e o Ranking já abre nela.
  const tipos = [DESTAQUE_TAB, ...TIPOS_BASE]
  const [tipo, setTipo] = useState('destaque') // destaque | geral | lideres | equipes
