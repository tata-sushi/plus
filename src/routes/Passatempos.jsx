...
const JOGOS = [
  ...
  { to: '/forca', jogo: 'forca', nome: 'Forca', desc: 'Descubra a palavra escondida', icon: WholeWord },
  { to: '/anagrama', jogo: 'anagrama', nome: 'Anagrama', desc: 'Desembaralhe a palavra do dia', icon: Shuffle },
]
