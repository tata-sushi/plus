...
export const governancaCatalogo = [
  { id: 'gov_escala', label: 'Controle de Escala', icon: 'CalendarClock', url: 'https://lideres.tatasushi.tech/compliance/kpis/rh/escalas.html' },
  ...
  { id: 'app_limpeza', label: 'Checklist de limpeza', icon: 'SprayCan', url: '/limpeza', app: true, need: 'podeLimpeza' },
]
