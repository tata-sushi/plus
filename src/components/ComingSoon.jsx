...
export function ComingSoon({ titulo, descricao }) {
  return (
    <div className="mx-5 mt-8 rounded-card border border-dashed border-line bg-surface/60 p-8 text-center">
      ...
      <span className="mt-4 inline-block pill bg-fill text-text">Em breve</span>
    </div>
  )
}
